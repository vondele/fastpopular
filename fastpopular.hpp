...
std::optional<std::string> get_optional(const nlohmann::json &j,
                                        const char *name) {
...
void from_json(const nlohmann::json &nlohmann_json_j,
  ...
  nlohmann_json_t.book_depth =
      get_optional(nlohmann_json_j, "book_depth").has_value()
          ? std::optional<int>(
                std::stoi(get_optional(nlohmann_json_j, "book_depth").value()))
          : std::nullopt;

  nlohmann_json_t.threads =
      get_optional(nlohmann_json_j, "threads").has_value()
          ? std::optional<int>(
                std::stoi(get_optional(nlohmann_json_j, "threads").value()))
          : std::nullopt;
